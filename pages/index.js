            ...
            <div className="right-inner" id="right-scroll" ref={rightScrollRef}>
              ...
              <div className={`content-section${current === 'portfolio' ? ' active' : ''}`} id="sec-portfolio">
                ...
                {[
                  ...
                  { num: '§ II', tag: 'Tax Management', title: 'Tax Performance & Compliance', desc: 'Managing VAT, income tax, and multi-branch reporting across multiple corporate entities with data-driven accuracy and operational efficiency — ensuring full regulatory compliance at all times.', tech: ['Tax Reporting','Compliance','Reconciliation'], links: [] },
                  { num: '§ III', tag: 'Sales Leadership', title: 'Sales Team Development', desc: 'Successfully supervised and trained multiple sales teams, consistently achieving and exceeding quarterly sales targets through effective coaching and strategic planning methodologies.', tech: ['Team Training','Sales Strategy','Performance'], links: [] },
                  ...
                  { num: '§ V', tag: 'Business Development', title: 'Partner Network Expansion', desc: 'Built and maintained strategic relationships with sales partners, expanding market reach and increasing revenue streams across regions through effective networking and relationship cultivation.', tech: ['Partnership','Networking','Growth'], links: [] },
                ].map(item => (
                  <div key={item.title} className="porto-entry">
                    ...
                    {(item.links.length > 0 || item.onCerts) && (
              ...
              <div className={`content-section${current === 'projects' ? ' active' : ''}`} id="sec-projects">
                ...
                {[
                  ...
                  { num: '§ III', tag: 'School Website',    title: 'Web Sekolah PAUD Fajar Pagi', desc: "A clean, welcoming website for an early childhood school. Built to help parents learn about the school's programmes and how to enrol their little ones.",                                        tech: ['Next.js','Tailwind','Vercel'],            links: [{ href: 'https://paud-fajar-pagi.vercel.app/', label: '→ Visit Application' }] },
